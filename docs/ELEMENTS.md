...
## [Main](https://github.com/beercss/beercss/blob/main/docs/MAIN.md)
...
Navs are navigation containers that display actions placed horizontally (or vertically). Elements, like buttons, chips, images, checkboxes, radios and switches can be placed inside a nav. Some examples of navs are navigation rail or navigation bar.
