...
<p align="center">
    ...
    <a href="https://bundlephobia.com/package/beercss@3.12.11" target="_blank"><img src="https://img.shields.io/bundlephobia/minzip/beercss@3.12.11" alt="minzipped size"></a>
...
```html
<link href="https://cdn.jsdelivr.net/npm/beercss@3.12.11/dist/cdn/beer.scoped.min.css" rel="stylesheet" />
<script type="module" src="https://cdn.jsdelivr.net/npm/beercss@3.12.11/dist/cdn/beer.min.js"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/material-dynamic-colors@1.1.2/dist/cdn/material-dynamic-colors.min.js"></script>
```
...
```html
<script type="module" src="https://cdn.jsdelivr.net/npm/beercss@3.12.11/dist/cdn/beer.custom-element.min.js"></script>
<script type="module" src="https://cdn.jsdelivr.net/npm/material-dynamic-colors@1.1.2/dist/cdn/material-dynamic-colors.min.js"></script>
```
...
Download all files from CDN https://cdn.jsdelivr.net/npm/beercss@3.12.11/dist/cdn/ and https://cdn.jsdelivr.net/npm/material-dynamic-colors@1.1.2/dist/cdn/. Now put the files inside a new folder in your project (like `/beercss` for example):
