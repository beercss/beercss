class BeerCssCustomElement extends HTMLElement {
  ...
  async addJs() {
    ...
    if (window.ui) return;
    return await import("https://cdn.jsdelivr.net/npm/beercss@3.10.0/dist/cdn/beer.min.js");
  }
  ...
  async addCss() {
    ...
    element.setAttribute("href", "https://cdn.jsdelivr.net/npm/beercss@3.10.0/dist/cdn/beer.scoped.min.css");
