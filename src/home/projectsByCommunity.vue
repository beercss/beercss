...
section#build-with 
  ...
  .grid
    .s12.m4.l3
      a.wrap(href="https://github.com/Materialious/Materialious", target="_blank")
        article.no-padding.round.wave.no-elevate
          ...
          nav.large-padding
            h6 Materialious
    .s12.m4.l3
      a.wrap(href="https://github.com/m4heshd/ufc-ripper", target="_blank")
        article.no-padding.round.wave.no-elevate.black
          ...
          nav.large-padding.white-text
            h6 UFC Ripper
    .s12.m4.l3
      a.wrap(href="https://github.com/bethropolis/haze-editor", target="_blank")
        article.no-padding.round.wave.no-elevate
          .center-align
          ...
          nav.large-padding
            h6 Haze editor
    .s12.m4.l3
      a.wrap(href="https://github.com/WardPearce/Purplix.io", target="_blank")
        article.no-padding.round.wave.no-elevate
          .center-align
