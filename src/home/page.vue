        ...
        #intro.col.s12
          article.flat.round.large-padding
            ...
            pre.wrap(style="font-family: courier new")
              ...
              |
              | &lt;script src="https://cdn.jsdelivr.net/npm/beercss@2.0.18/dist/cdn/beer.min.js" type="text/javascript"></script>
              |
...
export default {
  ...
  mounted() {
    ...
    this.themeSample = hljs.highlight(
      "js",
      'let theme = await ui("theme", { from: "color|file|blob|url|theme", mode: "light|dark" });'
    ).value;
