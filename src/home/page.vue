        ...
        #intro.s12
          .div
            ...
            pre.scroll.fill.no-round(style="font-family: courier new")
              | &lt;link href="https://cdn.jsdelivr.net/npm/beercss@2.2.5/dist/cdn/beer.min.css" rel="stylesheet"&gt;
              |
              | &lt;script src="https://cdn.jsdelivr.net/npm/beercss@2.2.5/dist/cdn/beer.min.js" type="text/javascript"&gt;&lt;/script&gt;
              |
