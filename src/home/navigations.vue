...
#navigations
  ...
  #navigation-drawer
    ...
    h6.middle-align
      ...
      a.chip.circle(@click="domain.showSamples(data, '#navigation-drawer > .row > nav', 'Navigation drawer', null, 'https://github.com/beercss/beercss/blob/main/docs/NAVIGATION.md')")
        i code
    nav.wrap
      label.radio
